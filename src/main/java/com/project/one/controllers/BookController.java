...
import com.project.one.services.BookService;
import com.project.one.services.PeopleService;
...
public class BookController {
    ...
    @GetMapping()
    public String index(Model model, @RequestParam(value = "page", required = false) Integer page,  @RequestParam(value = "books_per_page", required = false) Integer booksPerPage,
    ...
    public String search(Model model, @RequestParam(required = false, defaultValue = "") String search) {
        ...
        if (!search.isEmpty()) model.addAttribute("book", bookService.finByName(search));
        return "books/search";
    }
}
